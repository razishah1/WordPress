		...
		<div class="<?php echo esc_attr($portfolio_kit_blog_column); ?>">
			<main id="primary" class="site-main">
				...
				while (have_posts()) :
					...
					the_post_navigation(
						array(
							'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'portfolio-kit') . '</span> <span class="nav-title">%title</span>',
							'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'portfolio-kit') . '</span> <span class="nav-title">%title</span>',
						)
					);
